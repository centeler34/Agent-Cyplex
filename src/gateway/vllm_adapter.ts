/**
 * vLLM adapter — implements ModelClient for local vLLM instances.
 *
 * vLLM is a high-throughput LLM serving engine with an
...
export class VLLMAdapter implements ModelClient {
